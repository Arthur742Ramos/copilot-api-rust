...
| `COPILOT_API_SSE_STALL_TIMEOUT_SECS` | Dead-air budget for Copilot and provider streams; upstream SSE comments/WebSocket pings count as activity. Defaults to `120`; `0` disables it. |
