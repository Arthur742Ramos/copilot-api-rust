...
| Anthropic error envelopes and status-derived types | Supported | `src/libs/error.rs`; `router_smoke.rs` | 400/401/403/404/413/429/529/5xx map to stable Anthropic error types and JSON envelopes. |
